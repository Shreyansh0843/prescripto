  ...
  return userData && (
    <div className='max-w-lg flex flex-col gap-2 text-small'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 m,t-3 text-neutral-700'>
      ...
      <div>
        ...
        : <p className='text-gray-400'>{userData.gender}</p>
          ...
          {
            isEdit 
            ? <input className='max-w-28' type="date" onChange={(e) => setUserData(prev => ({...prev, gender: e.target.value}))} value={userData.dob}/>
