...
const MyAppointments = () => {
  ...
  return (
    <div>
      ...
      <div>
        {appointments.length === 0 ? <p className='p-4 text-sm text-gray-500'>No appointments</p> :
          ...
          <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key = {index}>
            ...
            <div className='flex-1 text-small text-zinc-600'>
              ...
              <p className='text-xs mt-1'><span className='text-sm text-neutral font-medium'>Date & Time:</span> {slotDateFormat(item.slotDate)} | {item.slotTime}</p>
            </div>
